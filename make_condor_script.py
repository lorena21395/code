...
print('Executable      = /gpfs01/astro/workarea/lmezini/deblender_tests/new_galsim_deblend_sing.py')
...
for i in range(1,1001):
    ...
    print('Arguments = /gpfs01/astro/workarea/lmezini/scarlet-tests/run145/run145_4-output-'+str(i).zfill(6)+'.fits 200 '+str(seed)+' /gpfs01/astro/workarea/lmezini/deblender_tests/config_files/config_v1.yaml')
    print('Queue')
