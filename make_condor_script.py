...
for i in range(1,201):
    ...
    print('+job_name = "run011-'+str(i).zfill(6)+'"')
    print('Arguments = /gpfs01/astro/workarea/lmezini/scarlet-tests/run011/run011-output-'+str(i).zfill(6)+'.fits 5000 '+str(seed)+' scarlet')
    print('Queue')
