...
for i in range(1,10001):
    ...
    print('+job_name = "run096-'+str(i).zfill(6)+'"')
    print('Arguments = /gpfs01/astro/workarea/lmezini/scarlet-tests/run096/run096-output-'+str(i).zfill(6)+'.fits 1000 '+str(seed)+' scarlet')
    print('Queue')
