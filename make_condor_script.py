...
for i in range(1,201):
    ...
    print('+job_name = "run016-'+str(i).zfill(6)+'"')
    print('Arguments = /gpfs01/astro/workarea/lmezini/scarlet-tests/run016/run016-output-'+str(i).zfill(6)+'.fits 5000 '+str(seed)+' scarlet')
    print('Queue')
