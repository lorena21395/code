...
for i in range(1,2501):
    ...
    print('Arguments = /gpfs01/astro/workarea/lmezini/scarlet-tests/run196/run196_6-output-'+str(i).zfill(6)+'.fits 400 '+str(seed)+' /gpfs01/astro/workarea/lmezini/deblender_tests/config_files/config-scar-sers-N5-r07-3band.yaml')
    print('Queue')
