...
for i in range(1,201):
    ...
    print('+job_name = "run020-'+str(i).zfill(6)+'"')
    print('Arguments = /gpfs01/astro/workarea/lmezini/scarlet-tests/run020/run020-output-'+str(i).zfill(6)+'.fits 5000 '+str(seed)+' scarlet')
    print('Queue')
