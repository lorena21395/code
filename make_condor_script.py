...
for i in range(1,101):
    ...
    print('+job_name = "run027-'+str(i).zfill(6)+'"')
    print('Arguments = /gpfs01/astro/workarea/lmezini/scarlet-tests/run027/run027-output-'+str(i).zfill(6)+'.fits 100 '+str(seed)+' scarlet')
    print('Queue')
